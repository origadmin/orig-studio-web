...
export default defineConfig({
    ...
    testMatch: /(bug-categories|bug-145-genre-select|bug-143-tag-routing|bug-171-tag-detail|bug-172-sidebar-ad|bug-147-like|bug-00[147][a-z0-9-]*|bug-15[34][a-z0-9-]*|_probe-[a-z0-9-]+)\.spec\.ts/,
    fullyParallel: false,
    workers: 1,
    retries: 0,
    timeout: 60000,
