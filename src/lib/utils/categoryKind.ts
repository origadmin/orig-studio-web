...
const taxonomyKindMap: Record<string, CategoryKind> = {
    ...
    'promo-brand': 'genre', 'promo-event': 'genre',
    'ugc-short': 'genre', 'ugc-live': 'genre',
    'film_tv-series': 'genre', 'film_tv-movie': 'genre', 'film_tv-variety': 'genre', 'film_tv-short': 'genre',
    'documentary-nature': 'genre', 'documentary-history': 'genre', 'documentary-society': 'genre',
    'gaming-console': 'genre', 'gaming-pc': 'genre', 'gaming-mobile': 'genre', 'gaming-live': 'genre',
    'sports-soccer': 'genre', 'sports-basketball': 'genre', 'sports-ese': 'genre', 'sports-general': 'genre',
    'ent-celeb': 'genre', 'ent-funny': 'genre', 'ent-music': 'genre', 'ent-variety': 'genre',
    'tech-digital': 'genre', 'tech-code': 'genre', 'tech-review': 'genre', 'tech-ai': 'genre',
    'life-food': 'genre', 'life-travel': 'genre', 'life-home': 'genre', 'life-fashion': 'genre',
    'other-uncat': 'genre',
};
