        ...
        <div className="space-y-8">
            ...
            <div className="pt-20 px-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-6 text-sm">
                    <div><span
                        className="font-semibold text-foreground">{formatViews(channel.subscriber_count)}</span><span
                        className="text-muted-foreground"> {t('common.subscribers')}</span></div>
                    <div><span
                        className="font-semibold text-foreground">{channel.media_count ?? 0}</span><span
                        className="text-muted-foreground"> {t('common.videos_count')}</span></div>
                </div>
                {channel.description && (
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="videos" className="mt-6">
                    {videos.length === 0 ? (
                        <div className="text-center py-12 text-muted-foreground">{t('channel.noVideos')}</div>
                    ) : (
                ...
                <TabsContent value="articles" className="mt-6">
                    {articlesLoading ? (
                        ...
                        <div className="text-center py-12 text-muted-foreground">{t('channel.noArticles')}</div>
                    )}
                </TabsContent>
                <TabsContent value="about" className="mt-6">
                    <div className="max-w-2xl"><h3
                        className="font-semibold text-foreground mb-4">{t('channel.description')}</h3><p
