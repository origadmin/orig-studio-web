...
const TagsPage = () => {
    ...
    return (
        <div className="space-y-6">
            {/* BUG-291 (design decision): title, search and sort share ONE row —
                the standalone search/sort rows wasted vertical space. */}
            <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {/* BUG-155: sort controls (heat / name / newest), now inline with the title */}
                    {!filter && (
                    ...
                    {sortedTags.map((tag) => {
                        ...
                        return (
                            <Link
                                ...
                                to="/tags"
                                search={{v: tagSlug}}
                                className="group flex items-center gap-2 p-3 bg-card border border-border rounded-lg hover:shadow-md transition-all hover:-translate-y-0.5"
